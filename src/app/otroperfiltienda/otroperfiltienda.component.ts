...
@Component({
  selector: 'app-otroperfiltienda',
  templateUrl: './otroperfiltienda.component.html',
  styleUrls: ['./otroperfiltienda.component.css']
})
export class OtroperfiltiendaComponent implements OnInit {
                ...
                .subscribe(data => {
                  if (aux) {
                    ...
                    data.map(element => {
                      ...
                      for (k = 1; k < n; k++) {
                        for (i = 0; i < (n - k); i++) {
                          if (this.listadoTodo[i].fecha !== undefined) {
